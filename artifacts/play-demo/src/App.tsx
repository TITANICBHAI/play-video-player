  ...
  return (
    <div className="w-full h-screen bg-play-bg text-white overflow-hidden relative font-sans flex items-center justify-center">
      <motion.div
        ...
        animate={{ opacity: currentScene === 0 || currentScene === 6 ? 0.3 : 0.8, scale: currentScene === 0 ? 1 : 1.1 }}
        transition={{ duration: 2, ease: "easeInOut" }}
      />
      <motion.div className="absolute w-[40vw] h-[40vw] rounded-full bg-play-accent/10 blur-[120px]"
        animate={{ x: currentScene === 0 ? '-10vw' : '20vw', y: currentScene === 0 ? '10vh' : '-20vh', scale: currentScene === 6 ? 1.5 : 1 }}
        transition={{ duration: 4, ease: "easeInOut" }}
      />
      <motion.div className="absolute w-[30vw] h-[30vw] rounded-full bg-play-highlight/5 blur-[100px]"
        animate={{ x: currentScene === 0 ? '10vw' : '-20vw', y: currentScene === 0 ? '-10vh' : '20vh', opacity: currentScene >= 2 && currentScene <= 5 ? 0.8 : 0.2 }}
        transition={{ duration: 4, ease: "easeInOut" }}
      />
          ...
          <AnimatePresence mode="wait">
            {currentScene === 0 && (
              <motion.div key="s0" initial={{ opacity: 0, scale: 0.9, filter: 'blur(10px)' }} animate={{ opacity: 1, scale: 1, filter: 'blur(0px)' }} exit={{ opacity: 0, scale: 1.1, filter: 'blur(10px)' }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="flex flex-col items-center justify-center h-full text-center translate-x-1/2">
                ...
                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.8 }} className="text-3xl text-gray-400 font-medium">Your Videos. Your Rules.</motion.p>
              </motion.div>
            )}
            {currentScene === 1 && (
              <motion.div key="s1" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} transition={{ duration: 0.6, ease: "easeOut" }} className="space-y-4">
            ...
            {currentScene === 2 && (
              <motion.div key="s2" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} transition={{ duration: 0.6, ease: "easeOut" }} className="space-y-4">
            ...
            {currentScene === 3 && (
              <motion.div key="s3" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} transition={{ duration: 0.6, ease: "easeOut" }} className="space-y-4">
            ...
            {currentScene === 4 && (
              <motion.div key="s4" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} transition={{ duration: 0.6, ease: "easeOut" }} className="space-y-4">
            ...
            {currentScene === 5 && (
              <motion.div key="s5" initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 40 }} transition={{ duration: 0.6, ease: "easeOut" }} className="space-y-4">
